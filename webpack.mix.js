...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/userDashboard.js', 'public/js')
    .js('resources/js/registerPage.js', 'public/js')
    .js('resources/js/passwordValidationForgotPassword.js', 'public/js')
    ...
    .postCss('resources/css/forgotPasswordPage.css', 'public/css')
    ...
    .postCss('resources/css/userDashboard.css', 'public/css')
