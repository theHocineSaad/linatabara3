...
return [
    ...
    'custom' => [
        ...
        'g-recaptcha-response' => [
            'required' => 'يرجى التحقق من أنك لست روبوتًا، مباشرة فوق زر التسجيل، بعد إعادة ملأ الإستمارة.',
            'captcha' => 'خطأ في كلمة التحقق (كابتشا)! حاول مرة أخرى لاحقًا أو اتصل بمسؤول الموقع.',
        ],
    ],
];
