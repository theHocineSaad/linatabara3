    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarToggler">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 fw-bold">
                <li class="nav-item">
                    <a class="nav-link {{ $homeActive ?? '' }}" aria-current="page"
                        href="{{ route('homePage') }}">{{ __('homePage.home') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $donorsActive ?? '' }}"
                        href="{{ route('donorsPage') }}">{{ __('homePage.donors') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $aboutActive ?? '' }}"
                        href="{{ route('aboutPage') }}">{{ __('homePage.about') }}</a>
                </li>
                <li class="nav-item">
            ...
            @auth
                <div class="dropdown d-flex justify-content-center">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="accountDropDownMenu">
                        <li><a class="dropdown-item" href="{{ route('dashboard') }}">{{ __('homePage.myAccount') }}</a>
                        </li>
            ...
            @else
                <div class="d-flex flex-column flex-xl-row">
                    ...
                    <a href="{{ route('login') }}"
                        class="text-dark text-decoration-none d-flex align-items-center justify-content-center mt-3 ms-xl-4 mt-xl-0">{{ __('homePage.myAccount') }}</a>
                </div>
            @endauth
