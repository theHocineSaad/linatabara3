<section class="cta py-5 my-5 bg-dark">
    ...
    <div class="shareBtns container d-flex flex-column flex-sm-row flex-wrap align-items-center justify-content-center">
        ...
        <a href="https://web.whatsapp.com/send?text={{ env('APP_URL') }}" class="whatsappShare btn d-flex align-items-center justify-content-center" target="_blank" rel="nofollow">
